...
CREATE INDEX IF NOT EXISTS occurrences_did_idx ON occurrences(did);
CREATE INDEX IF NOT EXISTS occurrences_event_date_idx ON occurrences(event_date);
...
CREATE INDEX IF NOT EXISTS identifications_did_idx ON identifications(did);
...
CREATE INDEX IF NOT EXISTS comments_subject_uri_idx ON comments(subject_uri);
