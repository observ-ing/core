...
impl jacquard_common::types::collection::Collection for Like<'_> {
    const NSID: &'static str = "org.rwell.test.like";
...
impl<'a> ::jacquard_lexicon::schema::LexiconSchema for Like<'a> {
    ...
    fn lexicon_doc() -> ::jacquard_lexicon::lexicon::LexiconDoc<'static> {
        lexicon_doc_org_rwell_test_like()
    }
    fn validate(
        &self,
...
fn lexicon_doc_org_rwell_test_like() -> ::jacquard_lexicon::lexicon::LexiconDoc<'static> {
    ::jacquard_lexicon::lexicon::LexiconDoc {
        lexicon: ::jacquard_lexicon::lexicon::Lexicon::Lexicon1,
        id: ::jacquard_common::CowStr::new_static("org.rwell.test.like"),
        revision: None,
        description: None,
        defs: {
