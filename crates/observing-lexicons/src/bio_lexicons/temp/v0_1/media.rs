...
//
// Lexicon: bio.lexicons.temp.v0-1.media
//
...
use crate::bio_lexicons::temp::v0_1::media;
#[allow(unused_imports)]
...
#[serde(
    rename_all = "camelCase",
    rename = "bio.lexicons.temp.v0-1.media",
    tag = "$type",
    bound(deserialize = "S: Deserialize<'de> + BosStr")
)]
...
impl<S: BosStr> LexiconSchema for AspectRatio<S> {
    ...
    fn lexicon_doc() -> LexiconDoc<'static> {
        lexicon_doc_bio_lexicons_temp_v0_1_media()
    }
...
impl XrpcResp for MediaRecord {
    const NSID: &'static str = "bio.lexicons.temp.v0-1.media";
...
fn lexicon_doc_bio_lexicons_temp_v0_1_media() -> LexiconDoc<'static> {
    use alloc::collections::BTreeMap;
    #[allow(unused_imports)]
    ...
    LexiconDoc {
        ...
        id: CowStr::new_static("bio.lexicons.temp.v0-1.media"),
        defs: {
