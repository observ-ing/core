...
//
// Lexicon: bio.lexicons.temp.v0-1.identification
//
...
#[serde(
    ...
    rename = "bio.lexicons.temp.v0-1.identification",
    tag = "$type",
...
impl XrpcResp for IdentificationRecord {
    const NSID: &'static str = "bio.lexicons.temp.v0-1.identification";
...
impl<S: BosStr> LexiconSchema for Identification<S> {
    ...
    fn lexicon_doc() -> LexiconDoc<'static> {
        lexicon_doc_bio_lexicons_temp_v0_1_identification()
    }
...
fn lexicon_doc_bio_lexicons_temp_v0_1_identification() -> LexiconDoc<'static> {
    use alloc::collections::BTreeMap;
    #[allow(unused_imports)]
    ...
    LexiconDoc {
        ...
        id: CowStr::new_static("bio.lexicons.temp.v0-1.identification"),
        defs: {
