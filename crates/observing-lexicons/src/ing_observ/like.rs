...
#[serde(rename_all = "camelCase", rename = "ing.observ.like", tag = "$type")]
pub struct Like<'a> {
...
impl XrpcResp for LikeRecord {
    const NSID: &'static str = "ing.observ.like";
...
fn lexicon_doc_ing_observ_like() -> LexiconDoc<'static> {
    #[allow(unused_imports)]
    ...
    LexiconDoc {
        ...
        id: CowStr::new_static("ing.observ.like"),
        defs: {
                        ...
                        properties: {
                            ...
                            map.insert(
                                ...
                                LexObjectProperty::String(LexString {
                                    description: Some(
                                        CowStr::new_static("Timestamp when this like was created."),
                                    ),
