...
//
// Lexicon: ing.observ.interaction
//
...
use crate::ing_observ::identification::Taxon;
use crate::ing_observ::interaction;
...
#[lexicon]
#[derive(Serialize, Deserialize, Debug, Clone, PartialEq, Eq, IntoStatic)]
#[serde(rename_all = "camelCase", rename = "ing.observ.interaction", tag = "$type")]
...
impl jacquard_common::IntoStatic for InteractionInteractionType<'_> {
    ...
    fn into_static(self) -> Self::Output {
        match self {
            InteractionInteractionType::Predation => {
                InteractionInteractionType::Predation
            }
            InteractionInteractionType::Pollination => {
                InteractionInteractionType::Pollination
            }
            InteractionInteractionType::Parasitism => {
                InteractionInteractionType::Parasitism
            }
            InteractionInteractionType::Herbivory => {
                InteractionInteractionType::Herbivory
            }
            InteractionInteractionType::Symbiosis => {
                InteractionInteractionType::Symbiosis
            }
            InteractionInteractionType::Mutualism => {
                InteractionInteractionType::Mutualism
            }
            InteractionInteractionType::Competition => {
                InteractionInteractionType::Competition
            }
            ...
            InteractionInteractionType::Oviposition => {
                InteractionInteractionType::Oviposition
            }
            InteractionInteractionType::SeedDispersal => {
                InteractionInteractionType::SeedDispersal
            }
...
impl<'a> Interaction<'a> {
    ...
    ) -> Result<RecordUri<'a, InteractionRecord>, UriError> {
...
impl<'a> LexiconSchema for InteractionSubject<'a> {
    fn nsid() -> &'static str {
        "ing.observ.interaction"
    }
    fn def_name() -> &'static str {
        "interactionSubject"
    }
    fn lexicon_doc() -> LexiconDoc<'static> {
        lexicon_doc_ing_observ_interaction()
    }
...
impl XrpcResp for InteractionRecord {
    const NSID: &'static str = "ing.observ.interaction";
...
fn lexicon_doc_ing_observ_interaction() -> LexiconDoc<'static> {
    #[allow(unused_imports)]
    ...
    LexiconDoc {
        ...
        id: CowStr::new_static("ing.observ.interaction"),
        defs: {
                        ...
                        map.insert(
                            ...
                            LexObjectProperty::Ref(LexRef {
                                r#ref: CowStr::new_static(
                                    "ing.observ.identification#taxon",
                                ),
                                ..Default::default()
                            }),
                        );
