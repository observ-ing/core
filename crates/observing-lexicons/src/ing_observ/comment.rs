...
#[serde(rename_all = "camelCase", rename = "ing.observ.comment", tag = "$type")]
...
impl XrpcResp for CommentRecord {
    const NSID: &'static str = "ing.observ.comment";
...
impl<'a> LexiconSchema for Comment<'a> {
    ...
    fn lexicon_doc() -> LexiconDoc<'static> {
        lexicon_doc_ing_observ_comment()
    }
...
fn lexicon_doc_ing_observ_comment() -> LexiconDoc<'static> {
    #[allow(unused_imports)]
    ...
    LexiconDoc {
        ...
        id: CowStr::new_static("ing.observ.comment"),
        defs: {
