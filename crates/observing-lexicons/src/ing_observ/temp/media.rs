...
use crate::ing_observ::temp::media;
...
#[lexicon]
#[derive(Serialize, Deserialize, Debug, Clone, PartialEq, Eq, IntoStatic)]
#[serde(rename_all = "camelCase", rename = "ing.observ.temp.media", tag = "$type")]
pub struct Media<'a> {
...
impl<'a> Media<'a> {
    ...
    ) -> Result<RecordUri<'a, MediaRecord>, UriError> {
...
impl<'a> LexiconSchema for AspectRatio<'a> {
    fn nsid() -> &'static str {
        "ing.observ.temp.media"
    }
    fn def_name() -> &'static str {
        "aspectRatio"
    }
    fn lexicon_doc() -> LexiconDoc<'static> {
        lexicon_doc_ing_observ_temp_media()
    }
...
impl XrpcResp for MediaRecord {
    const NSID: &'static str = "ing.observ.temp.media";
...
fn lexicon_doc_ing_observ_temp_media() -> LexiconDoc<'static> {
    #[allow(unused_imports)]
    ...
    LexiconDoc {
        ...
        id: CowStr::new_static("ing.observ.temp.media"),
        defs: {
...
impl<'a, S: media_state::State> MediaBuilder<'a, S> {
    ...
    pub fn aspect_ratio(
        mut self,
        value: impl Into<Option<media::AspectRatio<'a>>>,
    ) -> Self {
