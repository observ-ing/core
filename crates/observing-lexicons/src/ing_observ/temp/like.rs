...
#[serde(rename_all = "camelCase", rename = "ing.observ.temp.like", tag = "$type")]
pub struct Like<'a> {
...
impl<'a> LexiconSchema for Like<'a> {
    ...
    fn lexicon_doc() -> LexiconDoc<'static> {
        lexicon_doc_ing_observ_temp_like()
    }
...
fn lexicon_doc_ing_observ_temp_like() -> LexiconDoc<'static> {
    #[allow(unused_imports)]
    ...
    LexiconDoc {
        ...
        id: CowStr::new_static("ing.observ.temp.like"),
        defs: {
