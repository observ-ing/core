...
//
// Lexicon: ing.observ.identification
//
...
use crate::ing_observ::identification;
...
#[serde(rename_all = "camelCase", rename = "ing.observ.identification", tag = "$type")]
...
impl XrpcResp for IdentificationRecord {
    const NSID: &'static str = "ing.observ.identification";
...
impl<'a> LexiconSchema for Identification<'a> {
    fn nsid() -> &'static str {
        "ing.observ.identification"
    }
    fn def_name() -> &'static str {
        "main"
    }
    fn lexicon_doc() -> LexiconDoc<'static> {
        lexicon_doc_ing_observ_identification()
    }
...
fn lexicon_doc_ing_observ_identification() -> LexiconDoc<'static> {
    #[allow(unused_imports)]
    ...
    LexiconDoc {
        ...
        id: CowStr::new_static("ing.observ.identification"),
        defs: {
