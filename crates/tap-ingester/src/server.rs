...
///
/// Tap manages its own cursor server-side, so unlike the legacy
/// Jetstream ingester there's no client-side cursor or per-event
/// "last processed" timing surfaced here.
