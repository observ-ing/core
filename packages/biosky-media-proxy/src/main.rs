//! BioSky Media Proxy - High-performance media caching proxy
//!
...
async fn main() -> Result<()> {
    // Initialize logging
    let env_filter =
        EnvFilter::from_default_env().add_directive("biosky_media_proxy=info".parse()?);
    ...
    info!("Starting BioSky Media Proxy (Rust)...");
