...
describe("OAuthService", () => {
  ...
  describe("loopback detection", () => {
    ...
    it("treats production URLs as non-loopback", () => {
      const service = new OAuthService({ publicUrl: "https://biosky.app" });
      expect(service.clientId).toBe("https://biosky.app/client-metadata.json");
    });
  });
  ...
  describe("redirectUri generation", () => {
    ...
    it("uses public URL for production mode", () => {
      const service = new OAuthService({ publicUrl: "https://biosky.app" });
      expect(service.redirectUri).toBe("https://biosky.app/oauth/callback");
    });
  });
  ...
  describe("getClientMetadata", () => {
    ...
    it("returns full metadata in production", () => {
      ...
      expect(metadata["client_id"]).toBe("https://biosky.app/client-metadata.json");
      expect(metadata["client_name"]).toBe("BioSky");
      expect(metadata["client_uri"]).toBe("https://biosky.app");
    });
  });
